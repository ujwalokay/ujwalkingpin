...
export function CategoryCard({ title, icon: Icon, available, total, color, onViewDetails }: CategoryCardProps) {
  ...
  return (
    <Card 
      className="glass-card group shape-diagonal-rounded card-rectangular overflow-hidden cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all duration-300" 
